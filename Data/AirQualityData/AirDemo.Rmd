...
plot(PNW17$Date, PNW17$ArithmeticMean)
```
...
Montana18      <- readRDS (file = "USA/PNW/2018NorthWestUSA/Montana18.rds")
WaOrId18       <- readRDS (file = "USA/PNW/2018NorthWestUSA/WaOrId18.rds")
