...
% Tweaked for demo purpose August 2018
...
% Oversees the Information and Budget Management Unit which provides records and information management, budget and cost recovery support to the Superfund, RCRA and UST programs within OSRR
% Determines the overall program goals for the activities under his/her direction
% Oversees the development of strategies and alternatives in evaluating complex policy issues in the context of the New England environment
% Determines office resources needed to accomplish the work plan, and balances utilization of staff, training needs and travel budget
% Manages extramural resources, both procurement (contacts) and assistance (grants, cooperative agreements, and interagency agreements) properly and in compliance with regulatory requirements and Agency policies and procedures 
% Manages extramural resources, both procurement and assistance properly and in compliance with regulatory requirements.
\end{itemize}
...
\begin{itemize}
% Performs technical evaluations, comments on proposals for software/hardware procurement, enhancements, changes and standards  
% Coordinates regional Continuity of Operation Planning (COOP) activities; plans and schedules annual regional COOP exercise  
% Supervises the work of the Regional Information Security Officer
...
% \section {Transcript Categorization}
% \section {Transcript}
% \section{Appendix}
%blank
