...
Dynamic report generation by integrating code with narratives is not only easier but closely related to reproducible research. Dynamic report generation is an important step toward RR. (It does not guarantee RR.)
...
\begin{itemize}
    ...
    \item \url{https://yihui.name/knitr/demos/}
    \item Markdown or LaTeX, that is the question: \url{https://yihui.name/en/2013/10/markdown-or-latex/}
\end{itemize}
\end{frame}
