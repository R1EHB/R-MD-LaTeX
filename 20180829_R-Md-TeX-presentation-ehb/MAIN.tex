...
\begin{frame}{Other TeX Distros}
  Other TeX Distributions to be aware of:
  \begin{itemize}
  \item TinyTeX (https://yihui.name/tinytex/)
  \item proTeXt (http://www.tug.org/protext/)
  \item Bakoma TeX (Not Free; http://www.bakoma-tex.com)
  \item Also see: https://www.latex-project.org/get/
  \end{itemize}
\end{frame}
