...
* Introduction to the concept of reproducible research
...
* For following the lecture, none to minimal.

## For Hands-On Examples ##
### Skills ###
* Familarity with R and RStudio
...
* R packages:
  + knitr
  + ggplot2
  + pandoc (included as part of knitr, but also consider stand-alone version)
* MikTex (needed for optional LaTeX examples to try at home)


# Data Examples and Datasets #
* EPA and DOS air quality data (AIRS, etc)
* dslabs ?
